...
{
    [Range(0, 1)]
    public float alpha = 0.5f; // Ustawienie przezroczystoúci (0 = ca≥kowicie niewidoczny, 1 = ca≥kowicie widoczny)
    ...
    void SetObjectTransparency(float alpha)
    {
        ...
        {
            // Przejdü przez wszystkie materia≥y przypisane do renderera
            foreach (Material mat in renderer.materials)
            {
                // Sprawdü, czy materia≥ obs≥uguje przezroczystoúÊ
