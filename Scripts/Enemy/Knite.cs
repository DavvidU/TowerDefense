...
public class enemyKnite : MonoBehaviour
{
    ...
    private int currentLife = 150; // Aktualna iloœæ ¿ycia
...
public class enemyKniteBoss : MonoBehaviour
{
    ...
    private float timer = 0.0f;
    private GameObject gameControllerObj;
    private int currentLife = 350; // Aktualna iloœæ ¿ycia
    private TextMeshPro lifeText;
